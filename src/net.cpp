...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Uenocoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"uenocointools.com", "dnsseed.uenocointools.com"},
    {"uenocoinpool.org", "dnsseed.uenocoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"uenocointools.com", "testnet-seed.uenocointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Uenocoin is probably already running."), addrBind.ToString().c_str());
        else
